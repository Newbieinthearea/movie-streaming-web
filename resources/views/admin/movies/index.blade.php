                                ...
                                @forelse ($movies as $movie)
                                    <tr>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            @if($movie->poster_url)
                                                <img src="{{ $movie->poster_url }}" alt="{{ $movie->title }} poster" class="h-16 w-auto rounded">
                                            @else
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                            <a href="{{ route('admin.movies.edit', $movie) }}" class="text-indigo-600 hover:text-indigo-900 dark:text-indigo-400 dark:hover:text-indigo-300">Edit</a>
                                            <form action="{{ route('admin.movies.destroy', $movie) }}" method="POST" class="inline-block ml-2" onsubmit="return confirm('Are you sure you want to delete this movie?');">
                                                @csrf
                                                @method('DELETE')
